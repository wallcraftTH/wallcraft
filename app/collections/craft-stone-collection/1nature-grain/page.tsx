...
const HARDCODED_LIST: HardcodedProduct[] = [
  {
    ...
    itemCode: 'MBMW',
    size: '1200x2800x4mm',
    image: 'https://raw.githubusercontent.com/WaiHmueThit23/wallcraft_assets/main/nature_grain_collection/Asset%2053.webp',
  },
  {
    ...
    image: 'https://raw.githubusercontent.com/WaiHmueThit23/wallcraft_assets/main/nature_grain_collection/Asset%2052.webp',
  },
  {
    ...
    image: 'https://raw.githubusercontent.com/WaiHmueThit23/wallcraft_assets/main/nature_grain_collection/Asset%2051.webp',
  },
  {
    title: 'Shou-Suji-Ban',
    subtitle: '-',
    ...
    image: 'https://raw.githubusercontent.com/WaiHmueThit23/wallcraft_assets/main/nature_grain_collection/Asset%2050.webp',
  },
  {
    ...
    image: 'https://raw.githubusercontent.com/WaiHmueThit23/wallcraft_assets/main/nature_grain_collection/Asset%2049.webp',
  },
];
...
export default function NatureGrainPage() {
  ...
  const openModalFromDetail = (detail: HardcodedProduct) => {
    ...
    setModalState({
      title: detail.title,
      subtitle: detail.subtitle !== '-' ? detail.subtitle : 'Nature Grain Series',
  ...
  const openProductModalById = (productId: string) => {
    ...
    setModalState({
      title: product.title,
      subtitle: baseInfo && baseInfo.subtitle !== '-' ? baseInfo.subtitle : 'Nature Grain Series',
  ...
  return (
    <div className="font-sans bg-[#0a0a0a] text-white min-h-screen selection:bg-[#B08038]/30">
      ...
      >
        <img
          src="https://raw.githubusercontent.com/WaiHmueThit23/wallcraft_assets/main/collections_cover/nature.webp"
          alt="Nature Grain Collection Hero"
      ...
      <main className="max-w-[1600px] mx-auto px-8 lg:px-16 py-20 min-h-[50vh]">
        {loading ? (
          <div className="flex flex-col items-center justify-center space-y-4 py-20 opacity-60">
            ...
            <p className="text-[10px] uppercase tracking-[0.2em] text-zinc-500 font-medium">Synchronizing Nature Grain Textures...</p>
          </div>
        ) : (
