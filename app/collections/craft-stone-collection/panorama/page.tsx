...
const HARDCODED_LIST: HardcodedProduct[] = [
  {
    ...
    image:
      'https://raw.githubusercontent.com/WaiHmueThit23/wallcraft_assets/main/panorama/Asset%2034.webp',
  },
  {
    title: 'Marble Kalala',
    itemCode: 'MBDLS',
    size: 'W1200 x H600 x T4mm\nW1200 x H3000 x T4mm',
    image:
      'https://raw.githubusercontent.com/WaiHmueThit23/wallcraft_assets/main/panorama/Asset%2073.webp',
  },
  {
    ...
    size: 'W1200 x H600 x T4mm\nW1200 x H3000 x T4mm',
    image:
      'https://raw.githubusercontent.com/WaiHmueThit23/wallcraft_assets/main/panorama/Asset%2072.webp',
  },
];
  ...
  return (
    <div className="font-sans bg-[#0a0a0a] text-white min-h-screen">
      <header
        ...
        style={{
          backgroundImage:
            "linear-gradient(to right, rgba(10, 10, 10, 0.5) 0%, rgba(10, 10, 10, 0.2) 50%, rgba(10, 10, 10, 0) 100%), url('https://mpsnwijabfingujzirri.supabase.co/storage/v1/object/public/wallcraft_web/collections_cover/panorama.webp')",
        ...
        <div className="container mx-auto px-8 lg:px-24 z-20">
          <div className="max-w-2xl">
            ...
            <h1 className="text-5xl lg:text-8xl font-bold tracking-tight mb-6">
              <span className="text-[#B08038]">Panorama</span>
              <br />
        ...
        {loading ? (
          <div className="flex flex-col items-center justify-center space-y-4 py-20 opacity-60">
            ...
            <p className="text-[10px] uppercase tracking-[0.2em] text-zinc-500 font-medium">
              Synchronizing Panorama Textures...
            </p>
          </div>
        ) : (
