...
export default function PanoramaPage() {
  ...
  return (
    <div className="font-sans bg-[#0a0a0a] text-white min-h-screen selection:bg-[#B08038]/30">
      ...
      >
        <img
          src="https://raw.githubusercontent.com/WaiHmueThit23/wallcraft_assets/main/collections_cover/panorama.webp"
          alt="Panorama Collection Hero"
      ...
      <main className="max-w-[1600px] mx-auto px-8 lg:px-16 py-20 min-h-[50vh]">
        {loading ? (
          <div className="flex flex-col items-center justify-center space-y-4 py-20 opacity-60">
            ...
            <p className="text-[10px] uppercase tracking-[0.2em] text-zinc-500 font-medium text-center">Synchronizing Panorama Textures...</p>
          </div>
        ) : (
