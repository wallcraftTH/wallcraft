  ...
  return (
    <div className="font-sans bg-[#0a0a0a] text-white min-h-screen">
      <header
        ...
        style={{
          backgroundImage:
            "linear-gradient(to right, rgba(10, 10, 10, 0.5) 0%, rgba(10, 10, 10, 0.2) 50%, rgba(10, 10, 10, 0) 100%), url('https://raw.githubusercontent.com/WaiHmueThit23/wallcraft_assets/main/collections_cover/rust.webp')",
