...
const HARDCODED_LIST: HardcodedProduct[] = [
  {
    ...
    image: 'https://raw.githubusercontent.com/WaiHmueThit23/wallcraft_assets/main/urban_form_collection/Asset%2048.webp',
  },
  {
    title: 'Aggregate Wood',
    itemCode: 'MBQSW',
    size: 'W1000 x H2800 x T5(+-0.5)mm',
    image: 'https://raw.githubusercontent.com/WaiHmueThit23/wallcraft_assets/main/urban_form_collection/Asset%2047.webp',
  },
  {
    title: 'Fair Faced Concrete',
    itemCode: 'MBQSB',
    size: 'W1200 x H600 x T4mm\nW1200 x H3000 x T4mm',
    image: 'https://raw.githubusercontent.com/WaiHmueThit23/wallcraft_assets/main/urban_form_collection/Asset%2046.webp',
  },
];
...
export default function UrbanFormPage() {
  ...
  return (
    <div className="font-sans bg-[#0a0a0a] text-white min-h-screen selection:bg-[#B08038]/30">
      ...
      >
        <img
          src="https://raw.githubusercontent.com/WaiHmueThit23/wallcraft_assets/main/collections_cover/Urban.webp"
          alt="Urban Form Collection Hero"
        ...
        <div className="container mx-auto px-8 lg:px-24 relative z-20">
          <div className="max-w-2xl animate-reveal">
            ...
            <h1 className="text-5xl lg:text-8xl font-bold tracking-tight mb-6 leading-tight">
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/95 backdrop-blur-md text-left" onClick={(e) => { if (e.target === e.currentTarget) closeModal(); }}>
          <div className="relative w-full max-w-6xl bg-[#0f0f0f] border border-white/10 rounded-xl overflow-hidden shadow-2xl flex flex-col lg:flex-row max-h-[95vh]">
            ...
            <div className="w-full lg:w-2/5 p-8 lg:p-12 flex flex-col border-l border-white/5 bg-[#0a0a0a] overflow-y-auto no-scrollbar">
              <div className="mb-8">
                <h3 className="text-[#B08038] text-[10px] font-bold tracking-[0.4em] uppercase mb-2">Urban Form Series</h3>
              ...
              <div className="mb-8 p-4 bg-white/5 rounded-lg border border-white/5">
                ...
                <div className="flex flex-col space-y-1">
                  ...
                  <span className="text-zinc-300 text-sm font-light whitespace-pre-line leading-relaxed">{modalState.dimensions}</span>
                </div>
              </div>
