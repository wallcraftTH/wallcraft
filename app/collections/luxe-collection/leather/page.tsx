...
export default function LeatherCollection() {
    ...
    async function fetchCollection() {
      try {
        ...
        const { data, error } = await supabase
          .from('products')
          .select('*')
          .eq('collection_type', 'leather_collection');
  ...
  const handleDownloadSimple = async () => {
    ...
    try {
      ...
      link.href = blobUrl;
      link.download = `${currentProduct.item_code || currentProduct.title || 'leather'}.jpg`;
  ...
  return (
    <div className="bg-[#0a0a0a] text-white overflow-x-hidden antialiased font-sans">
      ...
      <header className="relative w-full h-[90vh] overflow-hidden flex items-center">
        <img
          src="https://raw.githubusercontent.com/WaiHmueThit23/wallcraft_assets/main/luxe_series/Asset%20139@2x.webp"
          alt="Leather Collection Hero"
          className="absolute inset-0 w-full h-full object-cover object-center block select-none scale-x-[-1]"
        />
        ...
        <div className="container mx-auto px-8 lg:px-24 relative z-20 pt-20">
          <div className="max-w-2xl animate-reveal">
            ...
            <h1 className="text-5xl lg:text-8xl font-bold tracking-tight mb-6 leading-none drop-shadow-2xl">
              <span className="text-[#B08038]">Leather</span>
              <br />
                    ...
                    <div className="w-full lg:w-1/2 flex flex-col items-center lg:items-start text-center lg:text-left">
                      ...
                      <div className="flex items-center gap-4 lg:gap-6 mb-10 w-full justify-center lg:justify-start">
                        ...
                        <div
                          ...
                          className={`flex gap-4 lg:gap-5 overflow-x-auto no-scrollbar w-[240px] lg:w-[400px] snap-x cursor-grab py-2 ${
                        ...
                        >
                          {group.variants.map((variant) => (
                            <button
                              ...
                              className="flex-none w-[70px] lg:w-[100px] aspect-square opacity-90 hover:opacity-100 cursor-pointer transition-all snap-center hover:scale-105 border border-white/10 hover:border-[#B08038]"
                            >
                              <img
          ...
          <div className="relative w-full max-w-5xl bg-[#0a0a0a] border border-white/10 rounded-sm overflow-hidden shadow-2xl flex flex-col lg:flex-row max-h-[95vh]">
            ...
            <div className="w-full lg:w-1/2 bg-[#050505] flex items-center justify-center p-8 relative">
              <img
                ...
                className="w-full h-auto border border-white/5 object-contain max-h-[80vh]"
              />
            </div>
            ...
            <div className="w-full lg:w-1/2 p-8 lg:p-10 flex flex-col overflow-y-auto no-scrollbar text-left relative bg-[#0a0a0a]">
              <div className="mb-4">
                ...
                <p className="text-white text-[10px] tracking-[0.3em] uppercase mb-4 font-bold">
                  {currentProduct.subtitle || 'Leather Series'}
                </p>
              ...
              <div className="mb-6">
                ...
                <div className="flex flex-wrap gap-3">
                  {currentVariants.map((variant) => {
                    const isActive = String(variant.id) === String(currentProduct.id);
                    const suffix =
                    ...
                    return (
                      ...
                      >
                        <div
                          className={`w-16 h-16 border transition-all ${
                            isActive
              ...
              <div className="mt-auto pt-6 border-t border-white/10 flex flex-col gap-5">
                ...
                <div className="flex gap-4 w-full">
                  ...
                  >
                    {downloadState ? 'ADDED' : 'Download Simple'}
                  </button>
