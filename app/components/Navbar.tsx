      ...
      <nav className={`fixed top-0 w-full z-50 px-8 py-6 hidden md:block transition-all duration-400 ${scrolled ? 'bg-black/95 py-2 backdrop-blur-md border-b border-white/5' : 'bg-black/40 backdrop-blur-md border-b border-white/5'}`}>
        <div className="max-w-[1800px] mx-auto flex justify-center items-center relative">
          ...
          <div className="flex items-center space-x-12">
            ...
            <div className="relative py-2 flex items-center group cursor-pointer">
              ...
              <div className="absolute left-1/2 -translate-x-1/2 top-full pt-4 w-60 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300">
                <div className="bg-zinc-900/95 backdrop-blur-2xl border border-white/5 p-6 space-y-4 shadow-2xl rounded-sm">
                  <Link href="/series/craft-stone" className="block text-[9px] uppercase tracking-[0.3em] text-zinc-400 hover:text-[#B08038]">Craft Stone Series</Link>
                  <Link href="/series/luxe" className="block text-[9px] uppercase tracking-[0.3em] text-zinc-400 hover:text-[#B08038]">Luxe Series</Link>
                  <Link href="/series/essential" className="block text-[9px] uppercase tracking-[0.3em] text-zinc-400 hover:text-[#B08038]">Essential Series</Link>
                </div>
              </div>
            </div>

            {/* Collection Dropdown (แก้ไขใหม่: มี 8 รายการ) */}
            <div className="relative py-2 flex items-center group cursor-pointer">
              ...
              <div className="absolute left-1/2 -translate-x-1/2 top-full pt-4 w-60 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300">
                {/* เพิ่ม max-h และ overflow-y-auto เผื่อหน้าจอสูงไม่พอสำหรับ 8 รายการ */}
                <div className="bg-zinc-900/95 backdrop-blur-2xl border border-white/5 p-6 space-y-4 shadow-2xl rounded-sm max-h-[80vh] overflow-y-auto no-scrollbar">
                  <Link href="/collection/tarra-stone" className="block text-[9px] uppercase tracking-[0.3em] text-zinc-400 hover:text-[#B08038] transition-colors">Tarra Stone</Link>
                  <Link href="/collection/panorama" className="block text-[9px] uppercase tracking-[0.3em] text-zinc-400 hover:text-[#B08038] transition-colors">Panorama</Link>
                  <Link href="/collection/strength-rock" className="block text-[9px] uppercase tracking-[0.3em] text-zinc-400 hover:text-[#B08038] transition-colors">Strength Rock</Link>
                  <Link href="/collection/geoform" className="block text-[9px] uppercase tracking-[0.3em] text-zinc-400 hover:text-[#B08038] transition-colors">Geoform</Link>
                  <Link href="/collection/urban-form" className="block text-[9px] uppercase tracking-[0.3em] text-zinc-400 hover:text-[#B08038] transition-colors">Urban Form</Link>
                  <Link href="/collection/nature-grain" className="block text-[9px] uppercase tracking-[0.3em] text-zinc-400 hover:text-[#B08038] transition-colors">Nature Grain</Link>
                  <Link href="/collection/rust" className="block text-[9px] uppercase tracking-[0.3em] text-zinc-400 hover:text-[#B08038] transition-colors">Rust</Link>
                  <Link href="/collection/finesse" className="block text-[9px] uppercase tracking-[0.3em] text-zinc-400 hover:text-[#B08038] transition-colors">Finesse</Link>
                </div>
              </div>
            </div>
            ...
            <div className="relative py-2 flex items-center group cursor-pointer">
              ...
              <div className="ml-2 p-1 group-hover:rotate-180 transition-transform duration-300">
               ...
               <div className="absolute left-1/2 -translate-x-1/2 top-full pt-4 w-60 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300">
                <div className="bg-zinc-900/95 backdrop-blur-2xl border border-white/5 p-6 space-y-4 shadow-2xl rounded-sm">
                  <Link href="#" className="block text-[9px] uppercase tracking-[0.3em] text-zinc-400 hover:text-[#B08038]">Visual Showcase</Link>
                  <Link href="#" className="block text-[9px] uppercase tracking-[0.3em] text-zinc-400 hover:text-[#B08038]">Project Showcase</Link>
                </div>
              </div>
            </div>
          ...
          <div className="absolute right-0 lg:right-8 flex items-center space-x-6">
            <button className="text-zinc-400 hover:text-white transition text-[9px] tracking-widest uppercase flex items-center">
