...
// --- Hardcoded List for Geoform ---
const HARDCODED_LIST = [
  {
    title: "Wave Line Stone",
    itemCode: "MBBLW",
    size: "1200x2800x6(+-0.5)mm",
    image: 'https://mpsnwijabfingujzirri.supabase.co/storage/v1/object/public/wallcraft_web/2.Band%20introduction/geoform_collection/Asset%2045.webp'
  },
  {
    title: "Cut Stone",
    itemCode: "MBBWS",
    size: "1200x600x5(+-0.5)mm\n1200x2800x5(+-0.5)mm",
    image: 'https://mpsnwijabfingujzirri.supabase.co/storage/v1/object/public/wallcraft_web/2.Band%20introduction/geoform_collection/Asset%2044.webp'
  },
  {
    title: "Wide Line Stone",
    itemCode: "MBCXS",
    size: "600x2800x6mm\n1200x2800x6mm",
    image: 'https://mpsnwijabfingujzirri.supabase.co/storage/v1/object/public/wallcraft_web/2.Band%20introduction/geoform_collection/Asset%2043.webp'
  },
  {
    title: "Square Line Stone",
    itemCode: "MBFXS",
    size: "580x2800x6(+-0.5)mm\n1000x2800x6(+-0.5)mm",
    image: 'https://mpsnwijabfingujzirri.supabase.co/storage/v1/object/public/wallcraft_web/2.Band%20introduction/geoform_collection/Asset%2042.webp'
  },
  {
    title: "Round Line Stone",
    itemCode: "MBYXS",
    size: "600x3000x6(+-0.5)mm\n1200x3000x6(+-0.5)mm",
    image: 'https://mpsnwijabfingujzirri.supabase.co/storage/v1/object/public/wallcraft_web/2.Band%20introduction/geoform_collection/Asset%2041.webp'
  },
  {
    title: "New Line Stone",
    itemCode: "MBXXS",
    size: "600x2800x5(+-0.5)mm\n1200x2800x5(+-0.5)mm",
    image: 'https://mpsnwijabfingujzirri.supabase.co/storage/v1/object/public/wallcraft_web/2.Band%20introduction/geoform_collection/Asset%2040.webp'
  },
  {
    title: "Aman Line Stone",
    itemCode: "MBSXS",
    size: "600x2400x6(+-0.5)mm\n1000x2400x6(+-0.5)mm",
    image: 'https://mpsnwijabfingujzirri.supabase.co/storage/v1/object/public/wallcraft_web/2.Band%20introduction/geoform_collection/Asset%2039.webp'
  },
  {
    title: "Mini Line Stone",
    itemCode: "MBSXS",
    size: "600x3000x5(+-0.5)mm\n1200x3000x5(+-0.5)mm", // Kept itemCode same as above per original HTML
    image: 'https://mpsnwijabfingujzirri.supabase.co/storage/v1/object/public/wallcraft_web/2.Band%20introduction/geoform_collection/Asset%2038.webp'
  },
  {
    title: "Curve Line Stone",
    itemCode: "MBQXS",
    size: "600x3000x6(+-0.5)mm\n1200x3000x6(+-0.5)mm",
    image: 'https://mpsnwijabfingujzirri.supabase.co/storage/v1/object/public/wallcraft_web/2.Band%20introduction/geoform_collection/Asset%2037.webp'
  },
  {
    title: "Delta Wing Stone",
    itemCode: "MBSWB",
    size: "980x2800x6.5(+-0.5)mm",
    image: 'https://mpsnwijabfingujzirri.supabase.co/storage/v1/object/public/wallcraft_web/2.Band%20introduction/geoform_collection/Asset%2061@2x.webp'
  },
  {
    title: "Culture Stone",
    itemCode: "MBXYS",
    size: "600x3000x7(+-0.5)mm\n1200x3000x7(+-0.5)mm",
    image: 'https://mpsnwijabfingujzirri.supabase.co/storage/v1/object/public/wallcraft_web/2.Band%20introduction/geoform_collection/Asset%2035.webp'
  }
];
  ...
  return (
    <div className="font-sans bg-[#0a0a0a] text-white min-h-screen">
      ...
      <header 
        ...
        style={{
            backgroundImage: `linear-gradient(to right, rgba(10, 10, 10, 0.6) 0%, rgba(10, 10, 10, 0.3) 50%, rgba(10, 10, 10, 0) 100%), url('https://mpsnwijabfingujzirri.supabase.co/storage/v1/object/public/wallcraft_web/collections_cover/Geoform.webp')`,
        ...
        <div className="container mx-auto px-8 lg:px-24 z-20 text-left">
          <div className="max-w-2xl animate-reveal">
            ...
            <h1 className="text-5xl lg:text-8xl font-bold tracking-tight mb-6">
              <span className="text-[#B08038]">Geoform</span><br />
            ...
            <p className="text-zinc-400 text-sm lg:text-base tracking-widest font-light uppercase max-w-lg leading-relaxed border-l border-[#B08038]/30 pl-6">
              Mathematical precision meeting raw elemental textures. Geometric rhythm for modern architectural depth.
            </p>
          </div>
        </div>
      </header>
      ...
      <main className="max-w-[1600px] mx-auto px-8 lg:px-16 py-20 min-h-[50vh]">
        {loading ? (
          <div className="flex flex-col items-center justify-center space-y-4 py-20 opacity-60">
            ...
            <p className="text-[10px] uppercase tracking-[0.2em] text-zinc-500 font-medium">Synchronizing Geoform Surfaces...</p>
          </div>
        ) : (
          <div>
            {HARDCODED_LIST.map((detail, i) => {
              const group = groups[detail.title.trim()] || {
                id: 'null',
                title: detail.title,
              ...
              return (
                <section key={i} className="mb-[10rem]">
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                    ...
                    {/* Left: Main Image */}
                    <div 
                      className="aspect-square w-[85%] mx-auto bg-zinc-900 rounded-sm shadow-2xl overflow-hidden cursor-zoom-in group relative flex items-center justify-center"
                    ...
                    >
                      ...
                      <div className="absolute inset-0 bg-black/30 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center text-center">
                        <div className="p-4 border border-white/30 bg-black/40 backdrop-blur-md">
                          <p className="text-white text-[10px] uppercase tracking-[0.2em] font-bold">View Detailed Form</p>
                        </div>
                      </div>
                    </div>

                    {/* Right: Details & Slider */}
                    <div className="flex flex-col h-full py-8 justify-between text-left">
                      <div>
                        <p className="text-[10px] text-[#B08038] tracking-[0.5em] uppercase mb-4 opacity-70 font-bold">Mathematical Series</p>
                        ...
                        <div className="space-y-6">
                          <div>
                            ...
                            <p className="text-[#B08038] text-lg tracking-wider">{detail.itemCode}</p>
                          </div>
                          <div>
                            <h4 className="text-[10px] uppercase tracking-[0.4em] text-zinc-500 mb-2 font-semibold">Standard Form</h4>
                            <div className="text-sm text-white/80 leading-loose whitespace-pre-line">
                              {detail.size}
                            </div>
                          </div>
                        </div>
                      ...
                      <div className="mt-12">
                        <h4 className="text-[9px] uppercase tracking-[0.5em] text-zinc-600 mb-6">Explore Structural Variants</h4>
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/90 backdrop-blur-sm animate-fade-in">
          <div className="relative w-full max-w-6xl bg-[#0f0f0f] border border-white/10 rounded-xl overflow-hidden shadow-2xl flex flex-col lg:flex-row max-h-[95vh]">
            ...
            <div className="w-full lg:w-2/5 p-8 lg:p-12 flex flex-col border-l border-white/5 bg-[#0a0a0a] overflow-y-auto no-scrollbar text-left">
              <div className="mb-8">
                <h3 className="text-[#B08038] text-[10px] font-bold tracking-[0.4em] uppercase mb-2">Geoform Signature</h3>
              ...
              <div className="mb-8 p-4 bg-white/5 rounded-lg border border-white/5">
                ...
                <div className="flex flex-col space-y-1">
                  ...
                  <span className="text-zinc-300 text-sm font-light whitespace-pre-line">{modalDetails.dimensions}</span>
                </div>
              </div>
