...
// --- Hardcoded List for Nature Grain ---
const HARDCODED_LIST = [
  {
    title: "Wood",
    itemCode: "MBMW",
    size: "1200x2800x4mm",
    image: 'https://mpsnwijabfingujzirri.supabase.co/storage/v1/object/public/wallcraft_web/2.Band%20introduction/nature_grain_collection/Asset%2053.webp'
  },
  {
    title: "Bamboo Board(B)",
    itemCode: "MBZWB",
    size: "600x2800(3.5-9)\n1000x2800(3.5-9)mm",
    image: 'https://mpsnwijabfingujzirri.supabase.co/storage/v1/object/public/wallcraft_web/2.Band%20introduction/nature_grain_collection/Asset%2052.webp'
  },
  {
    title: "Bamboo Board(A)",
    itemCode: "MBZWA",
    size: "600x2800(3.5-9)\n980x2800(3.5-9)mm",
    image: 'https://mpsnwijabfingujzirri.supabase.co/storage/v1/object/public/wallcraft_web/2.Band%20introduction/nature_grain_collection/Asset%2051.webp'
  },
  {
    title: "Shou-Suji-Ban",
    itemCode: "MBTHM",
    size: "600x2800x4mm",
    image: 'https://mpsnwijabfingujzirri.supabase.co/storage/v1/object/public/wallcraft_web/2.Band%20introduction/nature_grain_collection/Asset%2050.webp'
  },
  {
    title: "Carve Wood Board",
    itemCode: "MBJMB",
    size: "600x3000x6(+-0.5)mm\n1000x3000x6(+-0.5)mm",
    image: 'https://mpsnwijabfingujzirri.supabase.co/storage/v1/object/public/wallcraft_web/2.Band%20introduction/nature_grain_collection/Asset%2049.webp'
  }
];
  ...
  return (
    <div className="font-sans bg-[#0a0a0a] text-white min-h-screen">
      ...
      <header 
        ...
        style={{
            backgroundImage: `linear-gradient(to right, rgba(10, 10, 10, 0.5) 0%, rgba(10, 10, 10, 0.2) 50%, rgba(10, 10, 10, 0) 100%), url('https://mpsnwijabfingujzirri.supabase.co/storage/v1/object/public/wallcraft_web/collections_cover/nature.webp')`,
        ...
        <div className="container mx-auto px-8 lg:px-24 z-20 text-left">
          <div className="max-w-2xl animate-reveal">
            ...
            <h1 className="text-5xl lg:text-8xl font-bold tracking-tight mb-6 uppercase">
              <span className="text-[#B08038]">Nature Grain</span><br />
