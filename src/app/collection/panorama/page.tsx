...
// --- Hardcoded List for Panorama ---
const HARDCODED_LIST = [
  {
    title: "Marble",
    itemCode: "MBDLS",
    size: "1200x600x4mm\n1200x3000x4mm",
    image: 'https://mpsnwijabfingujzirri.supabase.co/storage/v1/object/public/wallcraft_web/2.Band%20introduction/panorama_collection/Asset%2034.webp'
  }
];

// --- Helper Component: Horizontal Slider ---
// Defined before main component or exported separately if needed, 
// but local definition is fine for page files.
...
export default function PanoramaPage() {
    ...
    const fetchData = async () => {
      try {
        const { data, error } = await supabase
          .from('products')
          .select('*')
          .eq('collection_type', 'Tarra Stone') // Adjust if your DB uses 'Panorama'
  ...
  const openModal = (product: Product | undefined, fallbackDetails: any) => {
    ...
    // Set details (Priority: DB > Hardcoded > Default)
  ...
  return (
    <div className="font-sans bg-[#0a0a0a] text-white min-h-screen">
      ...
      <header 
        ...
        style={{
            backgroundImage: `linear-gradient(to right, rgba(10, 10, 10, 0.5) 0%, rgba(10, 10, 10, 0.2) 50%, rgba(10, 10, 10, 0) 100%), url('https://mpsnwijabfingujzirri.supabase.co/storage/v1/object/public/wallcraft_web/collections_cover/panorama.webp')`,
        ...
        <div className="container mx-auto px-8 lg:px-24 z-20">
          <div className="max-w-2xl animate-reveal">
            ...
            <h1 className="text-5xl lg:text-8xl font-bold tracking-tight mb-6">
              <span className="text-[#B08038]">Panorama</span><br />
