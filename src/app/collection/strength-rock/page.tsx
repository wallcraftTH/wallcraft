...
// --- Hardcoded List for Strength Rock ---
const HARDCODED_LIST = [
  {
    title: "Rammed Earth Brick",
    itemCode: "MBHTZ",
    size: "1000x2800x6(=-0.5)mm",
    image: 'https://mpsnwijabfingujzirri.supabase.co/storage/v1/object/public/wallcraft_web/2.Band%20introduction/strength_rock_collection/Asset%2033.webp'
  },
  {
    title: "Granite",
    itemCode: "MBHGY",
    size: "600x1200x(3-7.5)mm\n600x3000x(3-7.5)mm\n1150x3000x(3-7.5)mm",
    image: 'https://mpsnwijabfingujzirri.supabase.co/storage/v1/object/public/wallcraft_web/2.Band%20introduction/strength_rock_collection/Asset%2032.webp'
  },
  {
    title: "Lunar Board",
    itemCode: "MBLUN",
    size: "1200x600x(3-10)mm\n1000x2800x(3-10)mm\n1000x3000x(3-10)mm",
    image: 'https://mpsnwijabfingujzirri.supabase.co/storage/v1/object/public/wallcraft_web/2.Band%20introduction/strength_rock_collection/Asset%2031.webp'
  },
  {
    title: "Massif Stone",
    itemCode: "MBCJY",
    size: "1100x2800x(3-13)mm",
    image: 'https://mpsnwijabfingujzirri.supabase.co/storage/v1/object/public/wallcraft_web/2.Band%20introduction/strength_rock_collection/Asset%2030.webp'
  },
  {
    title: "Shale Stone",
    itemCode: "MBDWS",
    size: "1160x3000x(4-19)mm",
    image: 'https://mpsnwijabfingujzirri.supabase.co/storage/v1/object/public/wallcraft_web/2.Band%20introduction/strength_rock_collection/Asset%2029.webp'
  },
  {
    title: "Continous Stone",
    itemCode: "MBDWS",
    size: "1160x3000x(3-13)mm", // Note: Item code duplicate in original HTML, kept as is
    image: 'https://mpsnwijabfingujzirri.supabase.co/storage/v1/object/public/wallcraft_web/2.Band%20introduction/strength_rock_collection/Asset%2028.webp'
  },
  {
    title: "Rockcut Stone",
    itemCode: "MBHSY",
    size: "600x1200x(4-13)mm\n1200x3000x(4-13)mm",
    image: 'https://mpsnwijabfingujzirri.supabase.co/storage/v1/object/public/wallcraft_web/2.Band%20introduction/strength_rock_collection/Asset%2027.webp'
  },
  {
    title: "Cliff Stone",
    itemCode: "MBQBY",
    size: "600x10600x(3-6)mm", // Kept original size string
    image: 'https://mpsnwijabfingujzirri.supabase.co/storage/v1/object/public/wallcraft_web/2.Band%20introduction/strength_rock_collection/Asset%2025.webp'
  },
  {
    title: "Deep Rock Stone",
    itemCode: "MBFKS",
    size: "600x3000x(3-12))mm\n1200x3000x(3-12)mm",
    image: 'https://mpsnwijabfingujzirri.supabase.co/storage/v1/object/public/wallcraft_web/2.Band%20introduction/strength_rock_collection/Asset%2026.webp'
  }
];
  ...
  return (
    <div className="font-sans bg-[#0a0a0a] text-white min-h-screen">
      ...
      <header 
        ...
        style={{
            backgroundImage: `linear-gradient(to right, rgba(10, 10, 10, 0.5) 0%, rgba(10, 10, 10, 0.2) 50%, rgba(10, 10, 10, 0) 100%), url('https://mpsnwijabfingujzirri.supabase.co/storage/v1/object/public/wallcraft_web/collections_cover/StrengthRock.webp')`,
        ...
        <div className="container mx-auto px-8 lg:px-24 z-20">
          <div className="max-w-2xl animate-reveal">
            ...
            <h1 className="text-5xl lg:text-8xl font-bold tracking-tight mb-6">
              <span className="text-[#B08038]">Strength Rock</span><br />
              <span className="text-[#c2bfb6]">Collection</span>
            </h1>
            <p className="text-[#c2bfb6] text-sm lg:text-base tracking-widest font-light uppercase max-w-lg leading-relaxed border-l border-[#B08038]/30 pl-6">
              Rugged mineral durability meets sophisticated modern architecture.
            </p>
          </div>
        </div>
      </header>
      ...
      <main className="max-w-[1600px] mx-auto px-8 lg:px-16 py-20 min-h-[50vh]">
        {loading ? (
          <div className="flex flex-col items-center justify-center space-y-4 py-20 opacity-60">
            ...
            <p className="text-[10px] uppercase tracking-[0.2em] text-zinc-500 font-medium">Synchronizing Strength Rock Textures...</p>
          </div>
        ) : (
          <div>
