...
// --- Hardcoded List for Urban Form ---
const HARDCODED_LIST = [
  {
    title: "Cement Design Board",
    itemCode: "MBSNJZ",
    size: "1000x3000x4.5(+-0.5)mm",
    image: 'https://mpsnwijabfingujzirri.supabase.co/storage/v1/object/public/wallcraft_web/2.Band%20introduction/urban_form_collection/Asset%2048.webp'
  },
  {
    title: "Aggregate Wood",
    itemCode: "MBQSW",
    size: "1000x2800x5(+-0.5)mm",
    image: 'https://mpsnwijabfingujzirri.supabase.co/storage/v1/object/public/wallcraft_web/2.Band%20introduction/urban_form_collection/Asset%2047.webp'
  },
  {
    title: "Fair Faced Concrete",
    itemCode: "MBQSB",
    size: "1200x600x4mm\n1200x3000x4mm",
    image: 'https://mpsnwijabfingujzirri.supabase.co/storage/v1/object/public/wallcraft_web/2.Band%20introduction/urban_form_collection/Asset%2046.webp'
  }
];
...
export default function UrbanFormPage() {
  ...
  const openModal = (product: Product | undefined, fallbackDetails: any) => {
    ...
    setModalDetails({
      ...
      dimensions: fallbackDetails.size || product?.dimensions || 'Standard Form'
    });
  ...
  return (
    <div className="font-sans bg-[#0a0a0a] text-white min-h-screen">
      ...
      <header 
        ...
        style={{
            backgroundImage: `linear-gradient(to right, rgba(10, 10, 10, 0.5) 0%, rgba(10, 10, 10, 0.2) 50%, rgba(10, 10, 10, 0) 100%), url('https://mpsnwijabfingujzirri.supabase.co/storage/v1/object/public/wallcraft_web/collections_cover/Urban.webp')`,
        ...
        <div className="container mx-auto px-8 lg:px-24 z-20 text-left">
          <div className="max-w-2xl animate-reveal">
            ...
            <h1 className="text-5xl lg:text-8xl font-bold tracking-tight mb-6">
              <span className="text-[#B08038]">Urban Form</span><br />
            ...
            <p className="text-zinc-400 text-sm lg:text-base tracking-widest font-light uppercase max-w-lg leading-relaxed border-l border-[#B08038]/30 pl-6">
              Architectural concrete and industrial textures redefined for contemporary urban spaces.
            </p>
          </div>
        </div>
      </header>
      ...
      <main className="max-w-[1600px] mx-auto px-8 lg:px-16 py-20 min-h-[50vh]">
        {loading ? (
          <div className="flex flex-col items-center justify-center space-y-4 py-20 opacity-60">
            ...
            <p className="text-[10px] uppercase tracking-[0.2em] text-zinc-500 font-medium">Synchronizing Urban Surfaces...</p>
          </div>
        ) : (
          <div>
                ...
                <section key={i} className="mb-[10rem] animate-reveal">
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                    ...
                    >
                      ...
                      <div className="absolute inset-0 bg-black/30 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center text-center">
                        <div className="p-4 border border-white/30 bg-black/40 backdrop-blur-md">
                          <p className="text-white text-[10px] uppercase tracking-[0.2em] font-bold">View Detailed Specification</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="flex flex-col h-full py-8 justify-between text-left">
                      <div>
                        <p className="text-[10px] text-[#B08038] tracking-[0.5em] uppercase mb-4 opacity-70 font-bold">Urban Series</p>
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/90 backdrop-blur-sm animate-fade-in">
          <div className="relative w-full max-w-6xl bg-[#0f0f0f] border border-white/10 rounded-xl overflow-hidden shadow-2xl flex flex-col lg:flex-row max-h-[95vh]">
            ...
            <div className="w-full lg:w-2/5 p-8 lg:p-12 flex flex-col border-l border-white/5 bg-[#0a0a0a] overflow-y-auto no-scrollbar text-left">
              <div className="mb-8">
                <h3 className="text-[#B08038] text-[10px] font-bold tracking-[0.4em] uppercase mb-2">Urban Signature</h3>
              ...
              <div className="mt-auto pt-8 border-t border-white/10">
                <div className="flex gap-4 mb-4">
                  <div className="flex items-center border border-white/20 rounded-md">
                    ...
                    <button onClick={() => selectedQty < 99 && setSelectedQty(q => q + 1)} className="px-4 py-3 text-white hover:bg-white/10">+</button>
                  </div>
                  <button 
...
function Slider({ products, onSelect }: { products: Product[], onSelect: (p: Product) => void }) {
  ...
  return (
    <div className="flex items-center space-x-4">
      <button onClick={() => scroll(-150)} className="w-10 h-10 border border-white/10 rounded-full flex items-center justify-center hover:border-[#B08038] transition-colors"><FaChevronLeft size={10} /></button>
      <div ref={scrollRef} className="flex space-x-4 overflow-x-auto py-2 no-scrollbar w-full">
        ...
        {products.length === 0 && <p className="text-[9px] opacity-30 italic px-4 py-8">Variants Syncing...</p>}
      </div>
      <button onClick={() => scroll(150)} className="w-10 h-10 border border-white/10 rounded-full flex items-center justify-center hover:border-[#B08038] transition-colors"><FaChevronRight size={10} /></button>
    </div>
  );
}